...
//     [IntlDateTime(DateStyle.Long)] public DateTime BookingStartDate { get; set; }
//     [IntlRelativeTime] public DateTime? BookingEndDate { get; set; }
//
...
//
//     [Reference] public Coupon Discount { get; set; }
...
//     [Required] public DateTime BookingStartDate { get; set; }
...
// {
//     [ValidateNotEmpty] public required string Description { get; set; }
//     [ValidateGreaterThan(0)] public int Discount { get; set; }
//     [ValidateNotNull] public DateTime ExpiryDate { get; set; }
// }
//
// [Tag("bookings")]
